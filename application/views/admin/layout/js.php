...
<!-- flot js -->
<!--[if lte IE 8]><script type="text/javascript" src="<?=base_url()?>assets/admin/js/excanvas.min.js"></script><![endif]-->
...
<script type="text/javascript" src="<?=base_url()?>assets/admin/js/maps/jquery-jvectormap-us-aea-en.js"></script>
<script>
    $(function () {
